...
import { sendContactMessage, type ContactMessage } from "./actions";
              ...
              <div className="terminal-success">
                ...
                <div className="term-body">
                  ...
                  <div style={{ marginTop: 18 }}>
                    <button className="btn ghost" type="button" onClick={onSendAnother}>
                      ENVIAR OTRO MENSAJE
                    </button>
                  </div>
                </div>
              ...
              <div className="terminal-success">
                ...
                <div className="term-body">
                  ...
                  <div className="line error">
                    &gt; ERROR: NO SE PUDO ENVIAR EL MENSAJE. {errorMsg.toUpperCase()}
                    <span className="caret">_</span>
                  </div>
                  <div style={{ marginTop: 18 }}>
